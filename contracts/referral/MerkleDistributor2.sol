...
contract MerkleDistributor2 is IMerkleDistributor {
    ...
    uint256[] private allClaimedIndex;
    ...
    function _setClaimed(uint256 index) private {
        ...
        allClaimedIndex.push(claimedWordIndex);
    }
    ...
    function resetRoot(bytes32 merkleRoot_) external {
        require(msg.sender == owner);
        merkleRoot = merkleRoot_;
        for (uint256 i = 0; i < allClaimedIndex.length; i++) {
            delete claimedBitMap[allClaimedIndex[i]];
        }
        delete allClaimedIndex;
    }
}
